    ...
    content: [
      createTextBlock({
        ...
        content: [
          ...
          p('FlowPilot already has native A2A support through its peer registry. With Google formalizing the protocol, the ecosystem of compatible agents is about to explode:'),
          ul(
          ...
          h2('Getting Started'),
          p('FlowPilot\'s A2A implementation is ready today. Connect peers in Admin → Agent Hub → A2A Peers. Define capabilities, exchange tokens, and start collaborating. As the ecosystem matures, your FlowPilot instance is already a first-class citizen.'),
        ],
      }),
    ],
    ...
    content: [
      createTextBlock({
        ...
        content: [
          ...
          p('Agents talking to agents via protocols like Google A2A. Your FlowPilot negotiating with a partner\'s agent to exchange leads, coordinate campaigns, or share market intelligence. The network effect begins.'),
          ...
          h2('Starting Today'),
          p('You do not need to wait for the full agentic web to arrive. FlowPilot gives you Wave 1 autonomy today, with Wave 2 A2A collaboration already built in. Start with a single objective — "publish 4 blog posts this month" — and experience what autonomous operations feel like.'),
        ],
      }),
    ],
    ...
    content: [
      createTextBlock({
        ...
        content: [
          ...
          p('A2A operates at a higher level — agent-to-agent collaboration. While function calling and MCP are about tool use within an agent, A2A is about coordination between agents. These are complementary, not competing.'),
          ...
          ul(
            ...
            'A2A peers receive skill capabilities as Agent Card manifests',
            'Future MCP integration will expose skills as MCP tool resources'
          ),
          h2('Why This Matters'),
          ...
          p('Today, use OpenAI or Gemini function calling. Tomorrow, add MCP servers for richer data integration. Next month, connect A2A peers for agent collaboration. FlowPilot\'s architecture supports all of these without rewriting a single skill.'),
        ],
      }),
    ],
