    ...
    blocks: [
      ...
      },
      {
        ...
        data: {
          ...
          testimonials: [
            { id: 't1', content: 'We went from idea to production in just 2 weeks. LaunchPad eliminated all the infrastructure headaches.', author: 'Sarah Chen', role: 'CTO', company: 'TechFlow', rating: 5 },
            { id: 't2', content: 'The best developer experience I\'ve ever had. The team actually listens to feedback and ships improvements weekly.', author: 'Marcus Lindberg', role: 'Lead Developer', company: 'InnovateCo', rating: 5 },
            { id: 't3', content: 'Scaled from 100 to 100,000 users without touching a single config file. It just works.', author: 'Emily Rodriguez', role: 'Founder', company: 'GrowthLab', rating: 5 },
          ],
          layout: 'carousel',
          columns: 3,
          showRating: true,
