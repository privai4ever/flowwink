...
export const consultAgencyTemplate: StarterTemplate = {
  ...
  requiredModules: ['blog', 'chat', 'leads', 'deals', 'companies', 'forms', 'bookings', 'newsletter'],
      ...
      blocks: [
        ...
        // CLIENT LOGOS — first trust signal, above the fold on scroll
        {
          ...
          data: {
            ...
            logos: [
              { id: 'cl1', name: 'Volvo Group', logo: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=160&h=50&fit=crop' },
              { id: 'cl2', name: 'Ericsson', logo: 'https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=160&h=50&fit=crop' },
              { id: 'cl3', name: 'SKF', logo: 'https://images.unsplash.com/photo-1611162618071-b39a2ec055fb?w=160&h=50&fit=crop' },
              { id: 'cl4', name: 'AstraZeneca', logo: 'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=160&h=50&fit=crop' },
              { id: 'cl5', name: 'SSAB', logo: 'https://images.unsplash.com/photo-1611162616475-46b635cb6868?w=160&h=50&fit=crop' },
              { id: 'cl6', name: 'Saab AB', logo: 'https://images.unsplash.com/photo-1611162617263-4ec3060a058e?w=160&h=50&fit=crop' },
            ],
            columns: 6,
            layout: 'grid',
            variant: 'grayscale',
    ...
    // ===== CONSULTANTS PAGE — The Roster =====
    {
      ...
      blocks: [
        ...
        // CHAT — find the right match
        {
          ...
          type: 'chat-launcher',
          data: {
            title: 'Can\'t Find the Right Profile?',
            subtitle: 'Describe your assignment to FlowPilot. Stack, timeline, budget. It will search the full network and present the best match — instantly.',
