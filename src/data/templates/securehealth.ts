...
const securehealthPages: StarterTemplate['pages'] = [
  {
    ...
    blocks: [
      { id: 'hero-1', type: 'hero', data: { title: 'Your Health, Your Privacy', subtitle: 'Trusted care with complete data security. Your information never leaves our servers.', backgroundType: 'image', backgroundImage: 'https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=1920', heightMode: '60vh', contentAlignment: 'center', overlayOpacity: 55, titleAnimation: 'fade-in', primaryButton: { text: 'Book Appointment', url: '/book' }, secondaryButton: { text: 'Our Services', url: '/services' } } },
      { id: 'divider-hero-badges', type: 'section-divider', data: { shape: 'wave', height: 'sm' } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: 'team-1', type: 'team', data: { title: 'Meet Our Doctors', subtitle: 'Board-certified specialists dedicated to your care.', members: [{ id: 'm1', name: 'Dr. Sofia Berg', role: 'Medical Director', bio: 'Board-certified in Internal Medicine with 20+ years of experience.', photo: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=300&h=300&fit=crop' }, { id: 'm2', name: 'Dr. James Wilson', role: 'Cardiologist', bio: 'Specialist in cardiovascular health and preventive care.', photo: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=300&h=300&fit=crop' }, { id: 'm3', name: 'Dr. Emily Chen', role: 'Pediatrician', bio: 'Caring for children of all ages with a gentle approach.', photo: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=300&h=300&fit=crop' }, { id: 'm4', name: 'Dr. Michael Torres', role: 'Mental Health', bio: 'Psychiatrist specializing in anxiety and depression.', photo: 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=300&h=300&fit=crop' }], columns: 4, layout: 'grid', variant: 'cards', showBio: true, showSocial: false } },
    ],
  },
  {
      ...
      { id: 'chat-1', type: 'chat-launcher', data: { title: 'Private AI Health Assistant', subtitle: 'HIPAA-compliant — all conversations stay private', placeholder: 'Ask about appointments, services, or health information...', showQuickActions: true, quickActionCount: 4, variant: 'card' } },
      {
        ...
        data: {
          ...
          items: [
            ...
            { question: 'Where are you located?', answer: { type: 'doc', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'We have multiple locations throughout the region. Each facility features free parking and full accessibility.' }] }] }, image: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=600', imageAlt: 'Modern medical facility' },
          ],
        },
      },
  ...
  },
  {
    ...
    blocks: [
      { id: 'hero-1', type: 'hero', data: { title: 'Book Your Appointment', subtitle: 'Choose your service, pick a time that works for you, and we\'ll take care of the rest.', backgroundType: 'image', backgroundImage: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=1920', heightMode: '60vh', contentAlignment: 'center', overlayOpacity: 55, titleAnimation: 'fade-in' } },
